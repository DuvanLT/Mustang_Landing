const MustangDetails = ({ mustangModelo }) => {
  return (
    <div className="Mustang__Top max-w-[1440px] m-auto flex flex-col md:flex-row md:justify-around md:items-center md:h-40 bg-zinc-950 text-white p-4" id="modelos">
     <div>
